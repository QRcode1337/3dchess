...
import type { Position, GameState, ValidMoves, Move, ChessPiece } from "@/types/chess"
...
export function useChessGame() {
  ...
  const capturedPieces = useMemo(() => {
    return moveHistory.filter((move) => move.captured !== null).map((move) => move.captured as ChessPiece)
  }, [moveHistory])
