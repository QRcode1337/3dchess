  ...
  return (
    <>
      ...
      <group ref={nebulaRef} position={[0, 0, 0]}>
        ...
        <pointLight position={[-30, 10, -20]} intensity={0.4} color={0x3311bb} distance={100} />
        <pointLight position={[30, -5, 20]} intensity={0.2} color={0x113366} distance={80} />
        <pointLight position={[-10, -10, -30]} intensity={0.1} color={0x661133} distance={60} />
      </group>

      {/* Ambient light to ensure pieces are visible */}
      <ambientLight intensity={0.7} color={0xccccdd} />
      ...
      <fog attach="fog" args={[0x000020, 40, 120]} />

      {/* Background color - slightly lighter to increase contrast with black pieces */}
      <color attach="background" args={[0x010a20]} />
    </>
  )
}
